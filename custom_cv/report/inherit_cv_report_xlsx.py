...
class InheritCVXlsx(models.AbstractModel):
    _inherit = "report.curriculum_vitae.standard_cv_report_data"
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        for line in lines:
            ...
            b_row = eh_row
            b_column = 0
            sheet.merge_range(b_row, b_column, b_row, b_column + 4, "Biography", title_format)
            b_row += 1
            sheet.set_row(b_row, 100)
            sheet.merge_range(b_row, b_column, b_row, b_column + 4, line.biography,
